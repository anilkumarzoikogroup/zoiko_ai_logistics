"""Centralised sys.path bootstrap for backend/governance.  Import this first in every module."""
import sys, os

ROOT     = os.path.dirname(os.path.abspath(__file__))          # …/backend/governance
