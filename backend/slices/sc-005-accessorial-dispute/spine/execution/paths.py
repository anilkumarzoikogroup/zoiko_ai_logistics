"""Bootstrap sys.path for sc-005 execution spine. Import first in every module."""
import sys, os

_EXECUTION = os.path.dirname(os.path.abspath(__file__))
_SPINE     = os.path.normpath(os.path.join(_EXECUTION, ".."))
